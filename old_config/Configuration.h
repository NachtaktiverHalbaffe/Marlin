...
#define STRING_CONFIG_H_AUTHOR "(Theblackraven)"         // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Version 0.95"       // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Almost Stable"        // will be shown during bootup in line 2
