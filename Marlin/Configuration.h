...
#define STRING_CONFIG_H_AUTHOR "(NachtaktiverHalbaffe and Theblackraven)" // Who made the changes.
...
#define HOTEND_OFFSET_Z \
  {                     \
    0.0, 1.3            \
  } // Z-offsets of the two hotends. The first must be 0.      // (ms) Delay for magnetic field. No delay if 0 or not defined.
//#define MANUAL_SOLENOID_CONTROL                   // Manual control of docking solenoids with M380 S / M381
 ...
 */
#define FIX_MOUNTED_PROBE //Bg: 2019-03-03 auskommentiert
...
#define FIL_RUNOUT_INVERTING false // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.
...
#define MANUAL_X_HOME_POS X_BED_SIZE + 11
#define MANUAL_Y_HOME_POS Y_BED_SIZE + 11
